  ...
  return (
    <Container>
      <div className="flex flex-col items-center gap-10 p-6">
        <p className="flex flex-col lg:flex-row lg:gap-4 justify-center font-sans text-5xl font-bold leading-7 text-dark-purple leading-headingCardsContainer text-center">
